...
class DriverRequestRepo {
  ...
  Future<ApiResponse> getScheduledRequest({required ref}) async {
    final response = _api
  ...
  Future<ApiResponse> getScheduledResidence(
      {required ref, required String id}) async {
  ...
  Future<ApiResponse> completeCleanUp(
      {required dynamic payload, required ref}) async {
  ...
  Future<ApiResponse> getSpecialRequest({required ref}) async {
    final response =
